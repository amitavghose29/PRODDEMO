		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Demo",
									"targetURL": "#comproddemoproddemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproddemoproddemo-display": {
								"semanticObject": "comproddemoproddemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prod.demo.proddemo",
									"url": sap.ui.require.toUrl("com/prod/demo/proddemo")
								}
							}
						}
					}
